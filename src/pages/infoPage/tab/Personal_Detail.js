                        ...
                        <div className='border-box form-entry'>
                            ...
                            >
                                ...
                                <Grid container spacing={1}>
                                    ...
                                    <Grid xs={2}>
                                        <Form.Item label="Driving License:" name={'drive_licence'}>
                                            <Input />
                                        </Form.Item>
                                    </Grid>
                                    <Grid xs={3}>
                                    ...
                                    <div className='case'>
                                        ...
                                        <Grid className="space-align-left" xs={12}>
                                            <Grid xs={9}>
                                                <Form.Item label="Goverment Officer:" name={'gov_officer'}>
                                                    <Input />
                                                </Form.Item>
                                        ...
                                        <Grid className="space-align-left" xs={12}>
                                            ...
                                            <Grid xs={9}>
                                                <Form.Item label="Office Address:" name={'office_address'}>
                                                    <Input />
                                                </Form.Item>
