...
import { Select, Table, Tag, Space, Button, Modal, Input, DatePicker, TimePicker, Avatar } from "antd";
  ...
  const [data, setData] = useState(() => {
    ...
    for (let i = 1; i < 46; i++) {
      initialData.push({
        ...
        timeIn: "09:00 AM",
        timeOut: "05:00 PM",
        imageUrl: `https://randomuser.me/api/portraits/men/${i}.jpg`, // Example image URL
      });
    }
    return initialData;
  });
